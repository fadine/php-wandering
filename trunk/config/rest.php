...
$config['rest_default_format'] = 'restfull';
...
$config['items_folder'] = WAPATH_BASE.DS."images/";

$config['items_thumb1_folder'] = WAPATH_BASE.DS."thumb1_images";
$config['items_thumb2_folder'] = WAPATH_BASE.DS."thumb2_images";
$config['param_files_folder'] = WAPATH_BASE.DS."param_images/";




//Thu muc chua sach dien tu
$config['ebooks_folder'] = WAPATH_BASE.DS."ebooks/";
$config['ebooks_lib_name'] = "PahayLibs";
$config['ebooks_num_per_page'] = 50;

$config['user_agent_name'] = "PahaySharedocs/1(Android)";

$config['ebooks_tmp'] = WAPATH_BASE.DS."epub/";
