...
class UserAgent {
	...
	{
		if (defined('ENVIRONMENT') AND is_file(WAPATH_SYSTEM.'config/'.ENVIRONMENT.'/user_agents.php'))
		{
			include(WAPATH_SYSTEM.'config/'.ENVIRONMENT.'/user_agents.php');
		}
		elseif (is_file(WAPATH_SYSTEM.'config/user_agents.php'))
		{
			include(WAPATH_SYSTEM.'config/user_agents.php');
		}
		else
		{
			return FALSE;
