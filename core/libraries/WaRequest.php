...
class WaRequest {
	...
	/**
	 * Array holder parameter of $_GET
	 *
	 * @var array
	 */
	...
	/**
	 * Array holder parameter of $_POST
	 *
	 * @var array
	 */
	...
	public function __construct() {
		...
		$this->utf8_enabled		= (config_item('charset')=="UTF-8" || config_item('charset')=="utf-8")?TRUE:FALSE;

		// Do we need the UTF-8 class?
		if ($this->utf8_enabled === TRUE)
		{
			global $UNI;
			$this->uni =load_class('WaUtf8');;
		}
	...
	/**
	 * Set value for attribute _method
	 *
	 * @param string $method
	 */
	...
	/**
	 * get value in parameter with key
	 *
	 * @return string
	 */
	...
	/**
	 * get array holder parameter of $_POST
	 *
	 * @return array
	 */
	...
	/**
	 * get value in $_POST with key
	 *
	 * @return string
	 */
	public function & getPostParam($name) {
		return (isset($this->_post_args[$name]))?$this->_post_args[$name]:null;
	}

	/**
	 * get array holder parameter of $_GET
	 *
	 * @return array
	 */
	...
	/**
	 * get value in $_GET with key
	 *
	 * @return string
	 */
	public function & getGetParam($name) {
		return (isset($this->_get_args[$name]))?$this->_get_args[$name]:null;
	}

	/**
	 * Check parameter existed
	 *
	 * @param string $name
	 * @return boolean
	 */
	...
	/**
	 * Check POST parameter existed
	 *
	 * @param string $name
	 * @return boolean
	 */
	public function hasPostParam($name) {
		return isset($this->_post_args[$name]);
	}

	/**
	 * Check GET parameter existed
	 *
	 * @param string $name
	 * @return boolean
	 */
	public function hasGetParam($name) {
		return isset($this->_get_args[$name]);
	}
	...
	*/
	function _sanitize_globals()
	{
		...
		if (is_array($_COOKIE) AND count($_COOKIE) > 0)
		{
			...
			// or silly application, that are of no use to a Wandering application anyway
